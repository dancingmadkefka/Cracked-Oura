      ...
      <div className="flex-1 flex flex-col min-w-0 p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3 min-w-0">
            <div className="h-10 w-10 rounded-2xl bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center shadow-lg shrink-0">
              <Bot className="h-5 w-5 text-white" />
            </div>
            <div className="min-w-0">
              <h1 className="font-['Space_Grotesk',sans-serif] text-xl font-semibold text-white/95 truncate">
                {activeThreadTitle || 'AI Analyst'}
              </h1>
          ...
          {messages.length > 0 && (
            <Button
              ...
              size="sm"
              onClick={onClear}
              className="gap-2 border-white/[0.08] bg-white/[0.04] text-white/50 hover:bg-white/[0.08] hover:text-white/80 shrink-0"
            >
