...
val trendMetricDefinitions = listOf(
    TrendMetricDefinition(
        ...
        shortLabel = "Sleep",
        unitLabel = "score",
        description = "Daily sleep score from the synced summary. Higher is better.",
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "Ready",
        unitLabel = "score",
        description = "Daily readiness score. Compare with its rolling baseline for context.",
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "Activity",
        unitLabel = "score",
        description = "Activity score from the daily summary.",
    ...
    TrendMetricDefinition(
        ...
        unitLabel = "hours",
        description = "Total sleep duration for the day. Uses all synced sleep sessions when available.",
    ...
    TrendMetricDefinition(
        ...
        description = "Approximate rolling sleep debt versus a local 14-day median sleep-need estimate.",
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "Deep",
        unitLabel = "hours",
        description = "Deep sleep duration from the primary synced sleep session.",
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "Steps",
        unitLabel = "steps",
        description = "Daily step count from the synced activity summary.",
        color = Color(0xFFFF8B4A),
    ...
    TrendMetricDefinition(
        ...
        unitLabel = "kcal",
        description = "Active calories burned that day.",
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "Goal",
        unitLabel = "% of target",
        description = "Progress toward the available calorie or walking-distance target.",
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "HRV",
        unitLabel = "ms",
        description = "Average HRV during the primary sleep session.",
        color = Color(0xFF18A685),
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "Avg HR",
        unitLabel = "bpm",
        description = "Average heart rate from the primary sleep session.",
    ...
    TrendMetricDefinition(
        ...
        shortLabel = "Temp",
        unitLabel = "°C",
        description = "Daily temperature deviation from the readiness summary.",
